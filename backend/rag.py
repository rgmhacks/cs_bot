...
class RAGAgent:
    def __init__(self, memory):
        ...
        try:
            ...
            print(f"Error during workflow initialization: {e}")
            self.graph = None  # Set it to None or handle it according to your needs
    ...
    def workflow(self):
        try:
            ...
            print(f"Error during workflow setup: {e}")
            return None  # Return None or handle according to your needs
    ...
    def get_response(self, user_query: str, user_id: str):
        ...
        try:
            ...
            return {"reply": "Sorry, something went wrong.", "isCompleted": False}
    ...
    def resume_chat(self, human_response: str, user_id: str):
        try:
            ...
            print(f"Error while resuming chat: {e}")
            return {"reply": "Sorry, something went wrong.", "isCompleted": False}
